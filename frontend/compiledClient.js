...
var App = (function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentWillMount() {
      ...
      _jquery2['default'].get('/yelp/search').then(function (response) {
        _this.setState({ body: response.body });
      }, function () {
        _this.setState({ body: 'Error fetching body!' });
      });
    }
  }]);
...
_react2['default'].render(_react2['default'].createElement(App, null), document.querySelector('body'));
